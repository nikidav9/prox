...
- Используй инструмент consult_agent когда задача явно требует другого специалиста
- Передавай конкретный вопрос, а не весь контекст
- После ответа коллеги — интегрируй его в свой итоговый ответ кратко
- НЕ консультируйся по очевидным вещам в своей области`;
